...
<div class="col-sm-12 col-md-8 pl-0 pr-0">
    <div class="card-box">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-element position-relative">
                ...
                <div style="width: 8rem;height: 8rem;" id="logo_cong_ty">
                    <img src="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['logo'] != null){{URL::asset(env('URL_ASSET_PUBLIC').$data['data']['logo'].'')}}@else{{URL::asset(env('URL_ASSET_PUBLIC').'images/default-company-logo.jpg')}}@endif"
                         class="avatar-xl img-thumbnail"
                         data-data="@if(isset($data['data']) && (count($data['data']) > 0)){{$data['data']['logo']}}@endif" name="logo_cong_ty"
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 text-left">
                <input class="form-control not-null" id="ten_cong_ty" title="Tên công ty"
                       value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['name'] != null){{$data['data']['name']}}@endif">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <input class="form-control" id="link_website" title="Website"
                       value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['websites'] != null){{$data['data']['websites']}}@endif">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 text-center text-md-right">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <input class="form-control not-null" id="email_cong_ty" data-rule="email" title="Email"
                       value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['email'] != null){{$data['data']['email']}}@endif">
                <span class="invalid-feedback" role="alert">
                            <strong></strong>
                        </span>
            </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <input class="form-control not-null" id="dien_thoai_cong_ty" maxlength="10"
                       title="Điện thoại"
                       value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['phone'] != null){{$data['data']['phone']}}@endif">
                <span class="invalid-feedback" role="alert">
                            <strong></strong>
                        </span>
            </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 text-left">
                <input class="form-control not-null" id="dia_chi_chinh" title="Địa chỉ chính"
                       value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['dia_chi'] != null){{$data['data']['dia_chi']}}@endif">
                <span class="invalid-feedback" role="alert">
                            <strong></strong>
                        </span>
            </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 text-left">
                <input class="form-control" id="so_luong_chi_nhanh" title="Số lượng chi nhánh" readonly
                       value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['dia_chi_chi_nhanh'] != null){{count($data['data']['dia_chi_chi_nhanh'])}}@else{{0}}@endif">
        ...
        <div class="row form-group  @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['dia_chi_chi_nhanh'] == null){{'d-none'}}@endif" id="dia_chi_chi_nhanh">
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 text-center text-md-right">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 text-left" id="dia_chi_chi_nhanh_append">
                @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['dia_chi_chi_nhanh'] != null)
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 pr-md-0">
                <div class="input-group">
                    ...
                    <input class="form-control not-null" style="border-left: none" id="from_time"
                           value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['gio_lam_viec'] != null){{$data['data']['gio_lam_viec'][0]}}@else{{date('08:00')}}@endif">
                    <span class="invalid-feedback" role="alert">
                            <strong></strong>
                        </span>
                </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 pl-md-0">
                <div class="input-group">
                    ...
                    <input class="form-control not-null" style="border-left: none" id="to_time"
                           value="@if(isset($data['data']) && (count($data['data']) > 0)&& $data['data']['gio_lam_viec'] != null){{$data['data']['gio_lam_viec'][1]}}@else{{date('17:30')}}@endif">
                    <span class="invalid-feedback" role="alert">
                            <strong></strong>
                        </span>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 pr-md-0 text-center">
                <div class="input-group">
                    ...
                    <select class="form-control text-center not-null" id="from_day" title="Ngày làm việc">
                        ...
                        <option value="1" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][0] == 1){{'selected'}}@endif @endif>{{__('Chủ nhật')}}</option>
                        <option value="2" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][0] == 2){{'selected'}}@endif @endif>{{__('Thứ hai')}}</option>
                        <option value="3" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][0] == 3){{'selected'}}@endif @endif>{{__('Thứ ba')}}</option>
                        <option value="4" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][0] == 4){{'selected'}}@endif @endif>{{__('Thứ tư')}}</option>
                        <option value="5" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][0] == 5){{'selected'}}@endif @endif>{{__('Thứ năm')}}</option>
                        <option value="6" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][0] == 6){{'selected'}}@endif @endif>{{__('Thứ sáu')}}</option>
                        <option value="7" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][0] == 7){{'selected'}}@endif @endif>{{__('Thứ bảy')}}</option>
                        <option value="8" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][0] == 8){{'selected'}}@endif @endif>{{__('Sáng - Thứ bảy')}}</option>
                    </select>
                    <span class="invalid-feedback" role="alert">
                            <strong></strong>
                        </span>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 pl-md-0 text-center">
                <div class="input-group">
                    ...
                    <select class="form-control not-null" id="to_day" title="Ngày làm việc">
                        <option value="" selected disabled>Chọn thứ</option>
                        <option value="1" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][1] == 1){{'selected'}}@endif @endif>{{__('Chủ nhật')}}</option>
                        <option value="2" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][1] == 2){{'selected'}}@endif @endif>{{__('Thứ hai')}}</option>
                        <option value="3" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][1] == 3){{'selected'}}@endif @endif>{{__('Thứ ba')}}</option>
                        <option value="4" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][1] == 4){{'selected'}}@endif @endif>{{__('Thứ tư')}}</option>
                        <option value="5" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][1] == 5){{'selected'}}@endif @endif>{{__('Thứ năm')}}</option>
                        <option value="6" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][1] == 6){{'selected'}}@endif @endif>{{__('Thứ sáu')}}</option>
                        <option value="7" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][1] == 7){{'selected'}}@endif @endif>{{__('Thứ bảy')}}</option>
                        <option value="8" @if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['ngay_lam_viec'] != null) @if($data['data']['ngay_lam_viec'][1] == 8){{'selected'}}@endif @endif>{{__('Sáng - Thứ bảy')}}</option>
                    </select>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <input class="form-control" id="fax_cong_ty" value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['fax'] != null){{$data['data']['fax']}}@endif">
            </div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <input class="form-control not-null" id="nam_thanh_lap" value="@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['nam_thanh_lap'] != null){{$data['data']['nam_thanh_lap']}}@else{{date('Y')}}@endif">
                <span class="invalid-feedback" role="alert">
                            <strong></strong>
                        </span>
            </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-element position-relative">
                <textarea class="form-control not-null break-custom" id="gioi_thieu_cong_ty">@if(isset($data['data']) && (count($data['data']) > 0) && $data['data']['gioi_thieu'] != null){{$data['data']['gioi_thieu']}}@endif</textarea>
                <span class="invalid-feedback" role="alert">
                            <strong></strong>
                        </span>
            </div>
